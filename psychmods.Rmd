---
title: "The Most And Least Popular Psychology Modules In NUS"
author: "Aaron0696"
output:
  html_document:
    fig_align: center
...
The page below is split into two halves. The `Codes` tab displays the codes used to extract and wrangle the data. The `Post` tab is a write-up that uses the wrangled data and various visualizations to find the most popular modules in NUS Psychology. 

Credits to:

* NUSMods, who scrapped and consolidated the data in an [API](https://nusmods.com/api/)
*  *Jon Spring* in the stackoverflow [thread](https://stackoverflow.com/questions/53162821/animated-sorted-bar-chart-with-bars-overtaking-each-other) for providing the base code for the animated GIFS. 
* Creators of the [Cayman](https://github.com/pages-themes/cayman) theme in Jekyll, where I adapted various aesthetics for the header and buttons.
</div>
</div>
<br>
...
```{r Honourplotlylsb, fig.height = 7, fig.width = 7, fig.align = "center", eval = htmlswitch, echo = gitswitch, out.width = '100%'}
# dataframe
popHonour <- mydata %>%
...
<img src="Honourgif.gif" width="520" height="390" alt="GIF of the cumulative mean of the lowest successful bid of honour psychology modules in NUS." />
...
```{r labplotly, fig.height = 7, fig.width = 7, fig.align = "center", eval = htmlswitch, echo = gitswitch, out.width = '100%'}
# dataframe
popLab <- mydata %>%
...
<img src="labgif.gif" width="520" height="390" alt="GIF of the cumulative mean of the lowest successful bid of lab psychology modules in NUS." />
...
```{r eleplotly, fig.height = 7, fig.width = 7, fig.align = "center", eval = htmlswitch, echo = gitswitch, out.width = '100%'}
# same comments as above code in Honours section
popElec <- mydata %>%
...
<img src="elegif.gif" width="520" height="390" alt="GIF of the cumulative mean of the lowest successful bid of elective psychology modules in NUS." />
