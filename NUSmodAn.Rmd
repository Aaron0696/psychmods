...
```{r explore1, warning = FALSE, , fig.width = 3, fig.height = 3}
...
```{r explore2, , fig.width = 3, fig.height = 3}
...
```{r explorecatcat, warning = FALSE, , fig.width = 3, fig.height = 3}
...
```{r exploreconcon, warning = FALSE, , fig.width = 3, fig.height = 3}
# create vector to loop across
...
```{r exploreconcat, warning = FALSE, fig.width = 3, fig.height = 3}
for(r in c("AcadYear", "Semester", "Round", "Level"))
{
...
```{r exploremodule, fig.height = 12, warning = FALSE}
for(i in c("Quota", "Bidders", "LowestBid", "LowestSuccessfulBid", "HighestBid", "BpQ"))
{
