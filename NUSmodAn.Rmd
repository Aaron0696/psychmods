...
```{r explore1, warning = FALSE, eval = FALSE, dpi = 150}
...
```{r explore2, warning = FALSE, eval = FALSE, dpi = 150}
...
```{r explorecatcat, warning = FALSE, eval = FALSE, dpi = 150}
...
```{r exploreconcon, warning = FALSE, eval = FALSE, dpi = 150}
...
```{r corrmatrix, fig.width = 4, fig.height = 4, dpi = 150}
...
```{r exploreconcat, warning = FALSE, eval = FALSE, dpi = 150}
for(r in facnames.mod)
{
  for(i in numnames)
  {
...
```{r exploremodule, fig.height = 12, warning = FALSE, eval = FALSE, dpi = 150}
for(i in numnames)
{
