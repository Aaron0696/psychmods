...
```{r explore1, warning = FALSE, eval = TRUE, dpi = 96}
...
```{r explore2, warning = FALSE, eval = TRUE, dpi = 96}
...
```{r explorecatcat, warning = FALSE, eval = TRUE, dpi = 96}
...
```{r exploreconcon, warning = FALSE, eval = TRUE, dpi = 96}
...
```{r corrmatrix, fig.width = 4, fig.height = 4, dpi = 96}
...
```{r exploreconcat, warning = FALSE, eval = TRUE, dpi = 96}
for(r in facnames.mod)
{
  for(i in numnames)
  {
...
```{r exploremodule, fig.height = 12, warning = FALSE, eval = TRUE, dpi = 96}
for(i in numnames)
{
