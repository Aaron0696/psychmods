...
```{r explore1, warning = FALSE, eval = TRUE, dpi = 300}
...
```{r explore2, warning = FALSE, eval = TRUE, dpi = 300}
...
```{r explorecatcat, warning = FALSE, eval = TRUE, , dpi = 300}
...
```{r exploreconcon, warning = FALSE, eval = TRUE, dpi = 300}
...
```{r exploreconcat, warning = FALSE, eval = TRUE, dpi = 300}
for(r in facnames.mod)
{
  for(i in numnames)
  {
...
```{r exploremodule, fig.height = 12, warning = FALSE, eval = TRUE, dpi = 300}
for(i in numnames)
{
