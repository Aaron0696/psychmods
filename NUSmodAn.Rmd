...
* Transform
    ...
    * Created a new variable `BpQ` that represents Bids per Quota, which is the number of bidders for each available quota of the module. Used as a measure of the popularity of a module, Higher `BpQ` signifies greater popularity.
* Merge
